...
buttonMasukan.addEventListener("click", function() {
    ...
    for (var i = 0; i < jumlahData; i++) {
        no++;
        textsnya += '<p>' + no + ' <input class="x" type="number" style="width: 45%;"> <input class="y" type="number" style="width: 45%;"></p>';
    }
...
function cetakTableHasil() {
    ...
    textsnya += '<p>' + sigma + ' <input class="ex" type="text" value="' + jumlahNilaiX +
        '" readonly="readonly"> <input class="ey" type="text"  value="' + jumlahNilaiY +
        '"readonly="readonly"> <input class="ex2" type="text"  value="' + jumlahNilaiXkuadrat +
        '"readonly="readonly"> <input class="ex2" type="text"  value="' + jumlahNilaiYKuadrat +
        '"readonly="readonly"> <input class="exkaliy" type="text"  value="' + jumlahNilaiXkaliY +
        '"readonly="readonly"> </p>';
    hasilTable.innerHTML = textsnya;
}

function cetakKonsataA() {
    var teks = "<p>a = ((&Sigma;y)(&Sigma;x<sup>2</sup>) - (&Sigma;y)(&Sigma;xy)) / n(&Sigma;x<sup>2</sup>) - (&Sigma;x)<sup>2</sup></p>";
    teks += "<p>a = ((" + jumlahNilaiY + ")(" + jumlahNilaiXkuadrat + ") - (" + jumlahNilaiY +
        ")(" + jumlahNilaiXkaliY + ")) / " + jumlahData + "(" + jumlahNilaiXkuadrat + ") - (" +
        jumlahNilaiX + ")<sup>2</sup></p>";
    teks += "<p>a = " + a + "</p><hr>";
...
function cetakKonsataB() {
    ...
    teks += "<p>b = (n(&Sigma;xy) - (&Sigma;x)(&Sigma;y)) / n(&Sigma;x<sup>2</sup>) - (&Sigma;x)<sup>2</sup></p>";
...
function rumusKorelasi() {
    ...
    rumusKorelasi += " / akar [(" + jumlahData + "*" + jumlahNilaiXkuadrat + ") - ^2(" + jumlahNilaiX + ") * ( (" +
        jumlahData + "*" + jumlahNilaiYKuadrat + ") - ^2(" + jumlahNilaiY + ")]";
